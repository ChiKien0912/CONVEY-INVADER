...
back_star = pygame.image.load('assets/back1.png')
...
stock_surface = pygame.image.load('assets/stock.png')
stock_rect_list = []
#Import pl.floor
floor = pygame.image.load('assets/runway.png')
floor_x_pos = 0


#Tạo các chướng ngại vật
obstacle1_surface = pygame.image.load('obstacle/obstacle1.png')
obstacle2_surface = pygame.image.load('obstacle/obstacle2.png')
obstacle3_surface = pygame.image.load('obstacle/obstacle3.png')
obstacle4_surface = pygame.image.load('obstacle/obstacle4.png')
obstacle5_surface = pygame.image.load('obstacle/obstacle5.png')
obstacle6_surface = pygame.image.load('obstacle/obstacle6.png')
obstacle7_surface = pygame.image.load('obstacle/obstacle7.png')
obstacle8_surface = pygame.image.load('obstacle/obstacle8.png')
obstacle9_surface = pygame.image.load('obstacle/obstacle9.png')
obstacle10_surface = pygame.image.load('obstacle/obstacle10.png')
obstacle11_surface = pygame.image.load('obstacle/obstacle11.png')
obstacle12_surface = pygame.image.load('obstacle/obstacle12.png')
obstacle13_surface = pygame.image.load('obstacle/obstacle13.png')
obstacle14_surface = pygame.image.load('obstacle/obstacle14.png')
obstacle15_surface = pygame.image.load('obstacle/obstacle15.png')
obstacle16_surface = pygame.image.load('obstacle/obstacle16.png')
obstacle17_surface = pygame.image.load('obstacle/obstacle17.png')
obstacle18_surface = pygame.image.load('obstacle/obstacle18.png')
obstacle19_surface = pygame.image.load('obstacle/obstacle19.png')
obstacle20_surface = pygame.image.load('obstacle/obstacle20.png')
